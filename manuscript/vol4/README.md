...
Drafted from scratch by Claude Code, following Volumes 1–3's structure, tone, and chapter shape, at Leo's request. All 16 screenshot placeholders are filled with illustrative mockups styled to match Windows 11, since there is no Windows PC in this environment to photograph directly.

## Chapter map

| Ch | Topic |
| --- | --- |
| 1 | Why your Windows PC is a target |
| 2 | Locking the front door (PIN, Windows Hello, screen lock, BitLocker) |
| 3 | Your Microsoft account and OneDrive |
| 4 | Windows Defender and app permissions |
| 5 | Scams, fake pop-ups and phishing |
| 6 | Wi-Fi, Windows Firewall and VPN |
| 7 | Backups, Find My Device, and what to do if things go wrong (incl. ransomware) |
| 8 | Your 15-minute Windows security checkup |
...
Volume 4 of 8. Series 1 (personal protection) concludes with Android Protection. Series 2 (organisational protection) covers Small Business, NGO & Not-for-Profit, and Personal Finance Protection.
