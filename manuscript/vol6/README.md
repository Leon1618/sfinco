...
Drafted from scratch by Claude Code, following Volumes 1–5's structure, tone, and chapter shape, at Leo's request. This is the first volume in Series 2 (organisational protection) and the first written for a small business owner audience rather than an individual consumer. All 10 screenshot placeholders are filled with illustrative mockups styled as generic business admin panels (email admin, router admin, business software, cloud backup), since there is no real business software account in this environment to capture directly.
...
| 2 | Locking the front door (passwords, password managers, MFA) |
| 3 | Email security and protecting your domain (SPF/DKIM/DMARC, forwarding rules) |
| 4 | Staff access worth trimming (least privilege, offboarding) |
| 5 | Scams targeting small businesses (BEC, invoice fraud, fake ATO/ASIC, domain renewal, ad account phishing) |
| 6 | Wi-Fi, point-of-sale, and remote access |
| 7 | Backups and incident response (3-2-1 rule, ransomware, Notifiable Data Breaches scheme) |
| 8 | Your 15-minute small business security checkup |
...
Volume 6 of 8. Opens Series 2 (organisational protection), alongside NGO & Not-for-Profit Protection and Personal Finance Protection.
