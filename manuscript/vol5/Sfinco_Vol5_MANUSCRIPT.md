...
This guide is for anyone who uses an Android phone and wants to feel confident that their personal information, their money, and their family are protected. You do not need to be "tech-savvy." You just need to be willing to spend a few hours going through these steps, most of which take less than two minutes each.

In particular, this guide will be helpful if you:

have ever received a suspicious text message with a link and wondered whether it was real

are not entirely sure what your Google Account is or why it matters so much

share a phone plan with family members and want to keep everyone safe

have a parent, grandparent, or older relative who uses an Android phone and worries about online scams
...
Everything in here is written the way I would explain it to my own mum, sitting next to her at the kitchen table with her phone in hand.
...
!  IMPORTANT:  Keeping your phone's software updated is one of the single most important things you can do for your security. Manufacturers regularly release updates that fix known vulnerabilities. We cover this in detail in Chapter 8.
...
The most widely used mobile operating system in the world is also the most attacked
...
Most people think of their phone as a way to call, text, and browse. Scammers think of it as a master key to your entire financial and personal life, already unlocked and in your pocket.


## How do attacks actually happen?


Attacks on Android users generally fall into a small number of well-worn patterns. Understanding them is most of the battle.

Phishing texts and calls.  A message or call appears to come from a delivery company, your bank, or a government agency, urging you to click a link or call back immediately. The link leads to a fake site designed to steal your details, or the call is a scammer posing as a trusted organisation.

Malicious or fake apps.  An app downloaded from outside the Google Play Store, or even one on the Play Store disguised as something legitimate, quietly requests far more access than it needs and uses that access to read your messages or steal your information.

Sideloading risks.  Android allows apps to be installed from outside the Play Store, a flexibility that also opens the door to apps that have not been checked by Google Play Protect at all.

Fake tech support and remote access scams.  Someone convinces you, usually by phone, to install a legitimate remote-access or screen-sharing app, then uses that access to look through your phone, guide you into your banking app, or ask for payment for problems that never existed.

Public Wi-Fi and Bluetooth risks.  Connecting to an unsecured public network can, in some circumstances, expose your traffic to someone else on the same network, particularly on older, less secure Wi-Fi setups.


## Why older Australians are targeted more


People over 60 are disproportionately targeted by phone and text-based scams. This is not because older people are less intelligent or less capable. It is because of several factors that scammers deliberately exploit: many people in this age group are less certain about what a "normal" app permission request or text message looks like, some live alone and value a friendly, patient voice on the phone, and many have significant savings that make a successful scam highly profitable for the criminal.


## The good news


Every single scam type in this chapter has a straightforward defence, and none of them require you to become a technical expert. A genuine bank or government agency never asks you to click a text link to "verify" your identity. Genuine tech support never phones you unprompted. And a phone with the settings covered in the rest of this book turned on is a genuinely difficult target.

| ✓  WELL DONE IF YOU HAVE THIS If you have never clicked a link in an unexpected text message, and you only install apps from the Google Play Store, you are already doing two of the most protective things an Android user can do. |

The rest of this book walks through exactly what to check, one chapter at a time, starting with the single most important layer: your lock screen itself.
...
Here are the most common scam types currently targeting Australian Android users, with real examples of what they look like.

1. Fake parcel delivery texts

A text message claims a parcel could not be delivered and asks you to click a link to reschedule or pay a small redelivery fee.
...
A text claims suspicious activity has been detected on your account and asks you to click a link or call a number to "secure" it.
...
3. Fake "family member in trouble" messages

A text arrives from an unknown number claiming to be a family member with a new phone, asking for urgent help, often followed by a request for money.
...
A message claims to come from the ATO, Medicare, or Services Australia, warning of an outstanding fine or a refund waiting to be claimed.
...
5. Phone call tech support and remote access scams
...
You are asked to act immediately.  Genuine organisations rarely demand instant action, and never by threatening to suspend or cancel something within minutes.

You are asked to click a link or call a number provided in the message itself.  Always look up the organisation's number or website independently instead.

The web address does not quite match the organisation's real one.  Look closely; scam links are often almost identical, but not quite, to the real thing.

You are asked to pay by gift card, wire transfer, or cryptocurrency, or to read out a one-time code.  No legitimate business asks for either.

The greeting is generic, or the request is unusually urgent for someone you know.  "Dear Customer" suggests a mass-sent scam; an urgent, out-of-character request from a "family member" is worth a direct phone call to check.
...
| Done | Item |
| --- | --- |
| ☐ | I know that genuine banks and government agencies never text a payment or verification link |
| ☐ | I check any "family member in trouble" request by calling their known number directly |
| ☐ | I never call phone numbers provided inside an unexpected text |
| ☐ | I know to hang up on any unsolicited caller asking to remote into my phone |
| ☐ | I never read a one-time code out loud to anyone who calls or texts me |

With scams covered, the next chapter looks at keeping your phone safe on Wi-Fi and browsing.
...
A simple monthly routine to keep your phone protected for years to come
...
Work through this list with your phone in hand. Each item references the chapter where you can find full instructions if you need a refresher.

### Lock screen and encryption

| Done | Item | Chapter |
| --- | --- | --- |
| ☐ | My screen lock remains a PIN, pattern, or password, not "None" or "Swipe" | Ch. 2 |
| ☐ | Screen timeout and lock timing are still set to a minute or less | Ch. 2 |
| ☐ | Encryption is still active under Encryption & credentials | Ch. 2 |

### Google Account

| Done | Item | Chapter |
| --- | --- | --- |
| ☐ | Two-step verification is still active on my Google Account | Ch. 3 |
| ☐ | Play Protect shows no issues in the Play Store app | Ch. 3 |

### Apps and permissions

| Done | Item | Chapter |
| --- | --- | --- |
| ☐ | I have reviewed the Permission manager for anything unfamiliar | Ch. 4 |
| ☐ | I have uninstalled any app I have not used in the past six months | Ch. 4 |

### Scam awareness

| Done | Item | Chapter |
| --- | --- | --- |
| ☐ | I have not clicked a link from an unexpected text this month | Ch. 5 |
| ☐ | I have not read a one-time code out loud to anyone this month | Ch. 5 |

### Wi-Fi and browsing

| Done | Item | Chapter |
| --- | --- | --- |
| ☐ | Automatic connection to open networks remains turned off | Ch. 6 |
| ☐ | Chrome's Safe Browsing is still set to Enhanced or Standard protection | Ch. 6 |

### Backups

| Done | Item | Chapter |
| --- | --- | --- |
| ☐ | Google Backup shows a successful backup within the last week | Ch. 7 |
...
| Done | Item | Chapter |
| --- | --- | --- |
| ☐ | My phone is running the latest available Android security update | New |
| ☐ | All my apps are updated to their latest versions from the Play Store | New |
...
Check for system updates weekly, not just monthly.  Settings path: Settings > System > System update (or Settings > Security & privacy on some phones). Security fixes are often released between your monthly checkups, and installing them promptly closes gaps quickly.

Update your apps regularly.  Settings path: Open the Play Store app > tap your profile picture > Manage apps & device. An outdated app can carry a known security flaw long after it has been fixed in a newer version.
...
| Term | Definition |
| --- | --- |
| Encryption | The process of scrambling data on your phone so it can only be read using your PIN, pattern, or password as the key |
| Find My Device | Google's location and device tracking service, allowing you to locate, lock, or erase a lost or stolen Android phone |
| Google Account | The email address and password you use to sign in to Gmail, Google Photos, the Play Store, and most Google services |
...
| Sideloading | Installing an app from outside the Google Play Store, which skips Google's usual safety checks |
| Two-step verification | A security method requiring both your password and a code or prompt sent to a trusted device to sign in to your Google Account |
...
| --- | --- |
| My phone make and model | _________________________________ |
...
| Step | What to do |
| --- | --- |
| 1. Locate it | android.com/find |
| 2. Lock the phone | With a message and contact number on screen |
| 3. Change your Google Account password | From a different, trusted device |
| 4. Report to police | Provide the IMEI number and location |
...
| Done | Item | Chapter |
| --- | --- | --- |
| ☐ | PIN, pattern, or password strong and unique | Ch 2 |
| ☐ | Screen timeout and lock timing a minute or less | Ch 2 |
| ☐ | Encryption turned on | Ch 2 |
...
| ☐ | Play Protect shows no issues | Ch 3 |

### 🛡️ Apps and permissions

| Done | Item | Chapter |
| --- | --- | --- |
| ☐ | Permission manager reviewed | Ch 4 |
| ☐ | Unused apps uninstalled | Ch 4 |

### 🚨 Scams

| Done | Item | Chapter |
| --- | --- | --- |
| ☐ | No links clicked from unexpected texts | Ch 5 |

### 🛰 Wi-Fi and browsing

| Done | Item | Chapter |
| --- | --- | --- |
| ☐ | Automatic connection to open networks off | Ch 6 |
| ☐ | Safe Browsing still on | Ch 6 |
...
| Done | Item | Chapter |
| --- | --- | --- |
| ☐ | Phone running latest security update | Settings > System update |
| ☐ | All apps updated | Play Store > Manage apps & device |
