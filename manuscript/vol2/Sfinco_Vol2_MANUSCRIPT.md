...
| ▶  SOUNDS FAMILIAR? Barbara, 68, from Noosaville, was browsing recipe websites on her iMac when a page suddenly filled her screen: a flashing red warning saying her Mac was infected with fifteen viruses, with a phone number to call for "Apple Support." She called. The person on the line spent forty minutes convincing her to install a remote access program, then told her she needed a $389 annual "protection plan" paid by gift card. Barbara is not careless. She had used Macs for fifteen years and genuinely believed they could not get infected. That belief is exactly what the scammer was counting on. This is a composite example, built from patterns commonly reported to Scamwatch and IDCARE, not a specific real person. If it sounds familiar, that's exactly the point. |
...
![System Settings sidebar showing the Apple ID name and account panel](screenshots/ch3-apple-id-panel.png)
...
![Sign-In and Security screen showing Two-Factor Authentication turned on](screenshots/ch3-two-factor-auth.png)
...
![iCloud settings pane showing iCloud Drive and Find My Mac both turned on](screenshots/ch3-icloud-settings.png)
...
![Apple ID account page scrolled down showing a list of trusted devices, MacBook, iPhone, iPad](screenshots/ch3-trusted-devices.png)
...
![Full-screen browser pop-up warning mockup, styled as an illustrative example](screenshots/ch5-fake-virus-popup.png)
...
![Safari's fraudulent website warning screen](screenshots/ch5-safari-fraud-warning.png)
...
![Time Machine settings showing a backup disk connected and Back Up Automatically turned on](screenshots/ch7-time-machine.png)
...
![iCloud settings showing Find My Mac turned on, along with Find My network and Send Last Location](screenshots/ch7-find-my-mac.png)
