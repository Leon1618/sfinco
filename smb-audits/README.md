...
Still to build: pricing/scoping worksheet. See `docs/pillars-and-guides.md` in the repo root for pillar detail ($500–$2,000 per engagement, remote-first, Sunshine Coast SMBs).
